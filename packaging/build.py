...
args=[sys.executable,'-m','PyInstaller','--noconfirm','--clean','--windowed','--name','OpenDronePlanner','--exclude-module','PyQt6','--exclude-module','PyQt5','--collect-all','rasterio','--collect-all','pyproj','--collect-all','shapely']
